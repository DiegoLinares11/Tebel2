        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="fs-16 text-muted mb-5 mb-lg-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                </div>
                <div class="col-lg-6">
                    <div>
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="position-relative">
                                    <img src="front/images/ecommerce/img-4.jpg" alt="" class="img-fluid rounded">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="vstack gap-4">
                                    <img src="front/images/ecommerce/img-1.jpg" alt="" class="img-fluid rounded">
                                    <img src="front/images/ecommerce/img-3.jpg" alt="" class="img-fluid rounded">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card card-animate border-0">
                        <div class="card-body">
                            ...
                            <h5 class="fs-16 mt-3">PRINCIPIOS</h5>
                            <p class="text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                            <div>
                                <a href="#!" class="link-effect link-primary">Read More <i class="bi bi-arrow-right ms-2"></i></a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="col-xl-3 col-md-6">
                    <div class="team-box text-center">
                        <div class="team-img">
                            <img src="front/images/users/user-dummy-img.jpg" alt="" class="img-fluid rounded rounded-circle border border-dashed border-dark border-opacity-25">
                        </div>
                        <div class="mt-4 pt-1">
                            <a href="#!">
                                <h5>Founder</h5>
                            </a>
                            <p class="text-muted mb-0">Founder position</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div>
                        <img src="front/images/ecommerce/img-5.jpg" alt="" class="img-fluid rounded">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mt-4 mt-lg-0">
                        <p class="text-uppercase fw-medium text-muted">Title</p>
                        <h2 class="lh-base fw-semibold mb-3">Example title</h2>
                        <P class="text-muted fs-16">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</P>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card-body text-center p-4">
                                        ...
                                        <div class="mt-4 text-center pt-3">
                                            <div class="position-relative">
                                                ...
                                                <p class="fs-15 text-muted mt-3">It will be as simple as Occidental in fact, it will Occidental to an English person</p>
                                                <div class="mt-4">
